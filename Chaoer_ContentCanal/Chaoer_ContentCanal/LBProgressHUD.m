...
+ (instancetype)showHUDto:(UIView *)view withTips:(NSString *)mText animated:(BOOL)animated
{
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _toast.backgroundColor = [UIColor colorWithRed:0.00 green:0.00 blue:0.00 alpha:0.80];
        _toast.layer.cornerRadius = 10;
        _toast.layer.borderColor = [UIColor colorWithRed:0.82 green:0.82 blue:0.82 alpha:0.5].CGColor;
