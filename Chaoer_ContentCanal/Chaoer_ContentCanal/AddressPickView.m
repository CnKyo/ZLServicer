...
#define pickViewViewHeight 220.0f
...
-(void)_createView
{
    ...
    _bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, DEVICE_Height, DEVICE_Width, navigationViewHeight+pickViewViewHeight)];
    [self addSubview:_bottomView];
    //导航视图
    _navigationView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, DEVICE_Width, navigationViewHeight)];
    _navigationView.backgroundColor = [UIColor colorWithRed:0.96 green:0.96 blue:0.96 alpha:1.00];
    ...
    for (int i = 0; i <buttonTitleArray.count ; i++) {
        ...
        button.frame = CGRectMake(i*(DEVICE_Width-buttonWidth), 0, buttonWidth, navigationViewHeight);
        [button setTintColor:M_CO];
    ...
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, navigationViewHeight, DEVICE_Width, pickViewViewHeight)];
...
-(void)showBottomView
{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        CGRect mAR = _bottomView.frame;
        mAR.origin.y = DEVICE_Height-navigationViewHeight-pickViewViewHeight;
        _bottomView.frame = mAR;
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    CGFloat pickViewWidth = DEVICE_Width/3;
